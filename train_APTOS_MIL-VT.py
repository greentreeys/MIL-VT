...
def main():
    ...
    """Basic Setting"""
    data_path = r'/extracephonline/medai_shirlyyu/data/APTOS/Image/'
    csv_path = r'/extracephonline/medai_shirlyyu/data/APTOS/CSV/'
    save_model_path = r'/extracephonline/medai_shirlyyu/data/APTOS/PytorchModel/'
    csvName = csv_path + 'train.csv'
